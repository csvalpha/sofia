class CallbacksController < Devise::OmniauthCallbacksController
  ...
  def identity
    ...
    if user.persisted?
      ...
      if user.deactivated
      ...
      elsif sofia_account&.otp_enabled
        ...
        render(json: { state: 'password_prompt',
                       error_message: 'Inloggen mislukt door een error. Herlaad de pagina en probeer het nog een keer. <br/><i>Werkt het na een paar keer proberen nog steeds niet? Neem dan contact op met de ICT-commissie.</i>' })
      end
    else
