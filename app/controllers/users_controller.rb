class UsersController < ApplicationController
  ...
  def api_token # rubocop:disable Metrics/AbcSize
    ...
    options = { grant_type: 'client_credentials',
                client_id: Rails.application.credentials[Rails.env.to_sym][:banana_client_id],
                client_secret: Rails.application.credentials[Rails.env.to_sym][:banana_client_secret] }
