...
SimpleForm.setup do |config|
  ...
  # In an input, only the placeholder is validated. When typing / changing the input it is not validated again, 
  # so if the placeholder was valid, the validated checkmark stays visible, whilst it should not. 
  # To not give a false sense of correctness, I made the classes an empty string, so no validation checkmarks are shown to the user.
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'mb-3' do |b|
    ...
    b.wrapper :form_check_wrapper, class: 'form-check' do |bb|
      bb.use :input, class: 'form-check-input', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', tag: 'fieldset', class: 'mb-3' do |b|
    ...
    b.use :input, class: 'form-check-input', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
  ...
  config.wrappers :vertical_select, class: 'mb-3' do |b|
    ...
    b.optional :readonly
    b.use :label, class: 'form-label'
    b.use :input, class: 'form-select', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
    b.use :full_error, wrap_with: { class: 'invalid-feedback' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
  ...
  config.wrappers :vertical_multi_select, class: 'mb-3' do |b|
    ...
    b.wrapper class: 'd-flex flex-row justify-content-between align-items-center' do |ba|
      ba.use :input, class: 'form-select mx-1', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
    end
    b.use :full_error, wrap_with: { class: 'invalid-feedback d-block' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
  ...
  config.wrappers :vertical_range, class: 'mb-3' do |b|
    ...
    b.optional :step
    b.use :label, class: 'form-label'
    b.use :input, class: 'form-range', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
    b.use :full_error, wrap_with: { class: 'invalid-feedback' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end
  ...
  config.wrappers :horizontal_form, class: 'row mb-3' do |b|
    ...
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-control', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check', item_label_class: 'form-check-label', class: 'row mb-3' do |b|
    ...
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-check-input', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
  ...
  config.wrappers :horizontal_select, class: 'row mb-3' do |b|
    ...
    b.use :label, class: 'col-sm-3 col-form-label'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-select', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
      ba.use :full_error, wrap_with: { class: 'invalid-feedback' }
      ba.use :hint, wrap_with: { class: 'form-text' }
    end
  end
  ...
  config.wrappers :horizontal_multi_select, class: 'row mb-3' do |b|
    ...
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.wrapper class: 'd-flex flex-row justify-content-between align-items-center' do |bb|
        bb.use :input, class: 'form-select mx-1', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
      end
      ba.use :full_error, wrap_with: { class: 'invalid-feedback d-block' }
      ba.use :hint, wrap_with: { class: 'form-text' }
    end
  ...
  config.wrappers :horizontal_range, class: 'row mb-3' do |b|
    ...
    b.use :label, class: 'col-sm-3 col-form-label pt-0'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-range', error_class: config.input_field_error_class, valid_class: config.input_field_valid_class
      ba.use :full_error, wrap_with: { class: 'invalid-feedback' }
      ba.use :hint, wrap_with: { class: 'form-text' }
    end
  end
