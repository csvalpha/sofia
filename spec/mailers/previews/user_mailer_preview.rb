...
class UserMailerPreview < ActionMailer::Preview
  def account_creation_mail
    user = User.new(id: 999999, provider: 'sofia_account', activation_token: "mockup_activation_token")
    UserMailer.account_creation_email(user)
  end

  def forgot_password_mail
    user = User.new(id: 999999, provider: 'sofia_account', activation_token: "mockup_activation_token")
    sofia_account = SofiaAccount.new(id: 888888, user: user, username: 'mockup_username')
